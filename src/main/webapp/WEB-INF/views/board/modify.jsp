    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Boards">
          <a class="nav-link" href="/board/lsit">
    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">        
          <i class="fa fa-list-alt" aria-hidden="true"></i> Baord
          <i class="fa fa-list" aria-hidden="true"></i> <a href="/board/myboards">My Boards</a>         
        </div>
        <div class="card-body">
			  		...
			  		<form method="post" enctype="multipart/form-data">
					    ...
					    <div class="form-group">
					        ...
					        <div class="form-control" name="file" id="file">
					        	...
					        	<c:if test="${fileName != null}">
						        	...
						        	${fileName}</a>
						        	<a href="/board/modify?number=${board.number}&del=1"><i class="far fa-times-circle"></i></a>
					        	</c:if>
					        	<c:if test="${fileName == null}">
						...
						<div class="form-group">
					        <input type="text" class="form-control" name="del"
					        	style="display:none" value="${fileName==null?1:null}"/>
					    </div>
					    <!-- 2018-06-22 파일업로드 추가 -->
						<div class="form-group">
					        <label>첨부파일수정</label>
