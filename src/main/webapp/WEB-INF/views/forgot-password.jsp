      ...
      <div class="card-body">
        ...
        <form action="${pageContext.request.contextPath}/mail/mailSending" method="post">
          <div class="form-group">
            <input class="form-control" name="tomail" id="exampleInputEmail1" type="email" aria-describedby="emailHelp" placeholder="Enter email address">
          </div>
          <input type="submit" value="Password Email" class="btn btn-primary btn-block">
