        ...
        <div class="card-header">
          <c:if test="${!admin}">
          	<i class="fa fa-user-o" aria-hidden="true"></i>
				<a href="/admin/user">User Role</a> &nbsp;&nbsp;
		  </c:if> 
          <i class="fa fa-indent" aria-hidden="true"></i> <a href="/admin/board">Admin Board</a> &nbsp;&nbsp;
          <i class="fa fa-list-alt" aria-hidden="true"></i> <a href="/board/list">Boards</a></div>
        <div class="card-body">
